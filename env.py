...
USER_ACCOUNTS = [
    ...
    {
        'key': '3662',  # 如使用多个账号 key 不能重复
        'user_name': '18530893662',
        'password': 'lvyasen123.',
...
EMAIL_SENDER = '18530893662@163.com'  # 邮件发送者
EMAIL_RECEIVER = '18530893662@163.com'  # 邮件接受者 # 可以多个 [email1@gmail.com, email2@gmail.com]
EMAIL_SERVER_HOST = 'smtp.163.com'  # 邮件服务 host
EMAIL_SERVER_USER = '18530893662'  # 邮件服务登录用户名
EMAIL_SERVER_PASSWORD = 'QFLWVBPIMIWWFVVJ'  # 邮件服务登录密码
